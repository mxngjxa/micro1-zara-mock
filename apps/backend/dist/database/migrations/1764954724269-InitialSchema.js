...
exports.InitialSchema1764954724269 = void 0;
class InitialSchema1764954724269 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_answer_score" ON "answers" ("score") `);
        await queryRunner.query(`CREATE INDEX "IDX_answer_question" ON "answers" ("question_id") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_question_interview_order" ON "questions" ("interview_id", "order") `);
        await queryRunner.query(`CREATE TYPE "public"."interviews_difficulty_enum" AS ENUM('JUNIOR', 'MID', 'SENIOR')`);
        await queryRunner.query(`CREATE TYPE "public"."interviews_status_enum" AS ENUM('PENDING', 'IN_PROGRESS', 'COMPLETED', 'ABANDONED')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_interview_started_at" ON "interviews" ("started_at") `);
        await queryRunner.query(`CREATE INDEX "IDX_interview_user_status" ON "interviews" ("user_id", "status") `);
        ...
        await queryRunner.query(`ALTER TABLE "questions" ADD CONSTRAINT "FK_6024b110ce4990aa1feb1386e0e" FOREIGN KEY ("interview_id") REFERENCES "interviews"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "questions" DROP CONSTRAINT "FK_6024b110ce4990aa1feb1386e0e"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_question_interview_order"`);
...
exports.InitialSchema1764954724269 = InitialSchema1764954724269;
//# sourceMappingURL=1764954724269-InitialSchema.js.map